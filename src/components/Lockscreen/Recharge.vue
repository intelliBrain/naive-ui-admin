  ...
  <div class="container">
    ...
    <div class="charging">
      ...
      <span v-show="Number.isFinite(battery.chargingTime) && battery.chargingTime != 0">
        When the battery is fully charged:{{ calcChargingTime }}
      </span>
    </div>
  </div>
</template>
...
<script lang="ts">
  ...
  export default defineComponent({
    ...
    props: {
      ...
      calcDischargingTime: {
        // Remaining battery time available time
        type: String,
        default: '',
      },
      calcChargingTime: {
      ...
      batteryStatus: {
        // Battery status
        type: String,
        validator: (val: string) => ['Charging', 'Be Filled', 'Power disconnected'].includes(val),
      },
    },
  });
</script>
